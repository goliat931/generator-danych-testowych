document.addEventListener("DOMContentLoaded", () => {
  ...
  // Funkcja czyszcząca po wpisaniu (inline validation feedback) / Clear validation feedback on input
  function clearValidationFeedback(inputElement, resultElement) {
