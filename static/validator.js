document.addEventListener("DOMContentLoaded", () => {
  ...
  function clearMessage(element, inputElement) {
  ...
  peselInput.addEventListener("input", () => {
    clearMessage(peselResult, peselInput);
  });
  ...
  regonInput.addEventListener("input", () => {
    clearMessage(regonResult, regonInput);
  });
  ...
  nrbInput.addEventListener("input", () => {
    clearMessage(nrbResult, nrbInput);
  });
